 ...
 * limitations under the License.
 */
function j(t){return t&&t._delegate?t._delegate:t}},125:(t,e,n)=>{n.d(e,{h1:()=>c,uA:()=>r});var i=n(72);class r{constructor(t,e,n){this.name=t,this.instanceFactory=e,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class c{constructor(t){this.name=t,this.providers=new Map}addComponent(t){const e=this.getProvider(t.name);if(e.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);e.setComponent(t)}addOrOverwriteComponent(t){const e=this.getProvider(t.name);e.isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);const e=new o(t,this);return this.providers.set(t,e),e}getProviders(){return Array.from(this.providers.values())}}},223:(t,e,n)=>{n.d(e,{Wp:()=>i.Wp});var i=n(928),r="firebase",s="11.9.1";
/**
 * @license
 ...
 * limitations under the License.
 */
(0,i.KO)(r,s,"app")},262:(t,e)=>{e.A=(t,e)=>{const n=t.__vccOpts||t;for(const[i,r]of e)n[i]=r;return n}},424:(t,e,n)=>{n.d(e,{$b:()=>r,Vy:()=>c});
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ut(t){dt(new i.uA("platform-logger",(t=>new D(t)),"PRIVATE")),dt(new i.uA("heartbeat",(t=>new Rt(t)),"PRIVATE")),_t(N,O,t),_t(N,O,"esm2017"),_t("fire-js","")}Ut("")},953:(t,e,n)=>{n.d(e,{C4:()=>S,EW:()=>Rt,Gc:()=>yt,IG:()=>Ct,Kh:()=>mt,Pr:()=>Nt,R1:()=>Dt,Tm:()=>Et,X2:()=>c,a1:()=>It,bl:()=>C,fE:()=>_t,g8:()=>wt,hV:()=>Ut,hZ:()=>P,i9:()=>xt,ju:()=>Tt,lJ:()=>At,qA:()=>F,u4:()=>L,ux:()=>St,wB:()=>Ft,yC:()=>o});var i=n(33);
/**
...
//# sourceMappingURL=chunk-vendors.f5f071cd.js.map