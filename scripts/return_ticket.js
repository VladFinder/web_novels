...
const scenes = {
    ...
    menu: {
        ...
        background: "assets/images/backgrounds/return_ticket/1.png",
        characters: [],
        choices: [
    ...
    gl1_name: {
        ...
        background: "assets/images/backgrounds/return_ticket/2.png",
        characters: [],
        choices: [
    ...
    gl1_sc1_1: {
        text: "Утро.",
        background: "assets/images/backgrounds/return_ticket/3.png",
        characters: [],
        choices: [
