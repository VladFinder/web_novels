...
const scenes = {
    ...
    gl1_sc1_7: {
        ...
        choices: [
            ...
            { text: "Полежать ещё пять минут – мир и так без тебя справится", nextScene: "gl1_sc1_7_choice2" }
        ]
    },
    gl1_sc1_7_choice1: {
    ...
    gl1_sc1_17: {
        text: "Май в столице – не весна, а ожидание весны. И, кажется, это ожидание затянулось.",
        background: "",
        characters: [],
        choices: [
    ...
    gl1_sc1_18: {
        ...
        characters: [],
        choices: [
            { text: "Собрать силы в кулак. «Я знала, на что шла.»", nextScene: "gl1_sc1_18_choice1_1" },
            { text: "Позволить себе легкую тоску.", nextScene: "gl1_sc1_18_choice2_1" }
        ]
    },
    gl1_sc1_18_choice1_1: {
        ...
        characters: [],
        choices: [
            { text: "Дальше", nextScene: "gl1_sc1_18_choice1_2" }
        ]
    },
    gl1_sc1_18_choice1_2: {
        text: "– Я справлюсь, – тогда ты сказала это вслух, как мантру.",
        background: "",
        characters: [],
        choices: [
            { text: "Дальше", nextScene: "gl1_sc1_18_choice1_3" }
        ]
    },
    gl1_sc1_18_choice1_3: {
        text: "И справилась. Жильё, работа, учёба, связи – всё сама.",
        background: "",
        characters: [],
        choices: [
            { text: "Дальше", nextScene: "gl1_sc1_18_choice1_4" }
        ]
    },
    gl1_sc1_18_choice1_4: {
        text: "Ты выдыхаешь. Всё ещё держишься. Всё ещё идёшь по курсу.",
        background: "",
        characters: [],
        choices: [
            { text: "Дальше", nextScene: "gl1_sc1_18_choice1_5" }
        ]
    },
    gl1_sc1_18_choice1_5: {
