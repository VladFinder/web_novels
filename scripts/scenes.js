...
const scenes = {
    ...
    dis: {
        text: "Дисклеймер: Вдохновением для данного произведения послужили гавайские культура и мифология, однако многие достоверные факты были изменены для художественного замысла авторов. Мы не претендуем на историческую достоверность, лишь знакомим читателя с культурой.",
        background: "assets\images\backgrounds\cutscenes\dis1.MP4",
        characters: [],
        audio: "assets\images\SOUNDS\music\ritual_music.mp3",
        choices: [
    ...
    dis20: {
        ...
        choices: [
            { text: "Дальше", nextScene: "dis20_1" }
        ]
    },
    dis20_1: {
        text: "Но маму Лейла так и не нашла. Вместо одного браслета, стала носить два.",
        background: "assets/images/backgrounds/volcano_cloud.jpg",
        characters: [],
        audio: "assets/audio/white_noise.mp3",
        choices: [
    ...
    choicegl1_3_1_2: {
        text: "Почти минуло десять лет с той ночи.\nТогда Лейла почти не плакала: по утрам она обыскивала леса, а по вечерам - помогала восстанавливать семейное кафе.",
        background: "assets\images\backgrounds\mirror.png",
        characters: [],
        choices: [
            { text: "Дальше", nextScene: "choicegl1_3_1_2_1" }
        ]
    },
    choicegl1_3_1_2_1: {
        text: "Это стало похоже на цель жизни: не дать “Охиа” закрыться.",
        background: "assets\images\backgrounds\mirror.png",
        characters: [],
        choices: [
            { text: "Дальше", nextScene: "choicegl1_3_1_2_2" }
        ]
    },
    choicegl1_3_1_2_2: {
    ...
    gl1_151nobruise7: {
        text: "И так собиралась полчаса, пошли уже!",
        background: "assets\images\backgrounds\hallway.png",
        characters: [{ name: "Хани", image:"assets\images\characters\Hani.PNG", position: "left" }],
        choices: [
